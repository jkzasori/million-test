...
echo "   Backend API: http://localhost:5000/api/properties"
echo "   Frontend:    http://localhost:3000"
echo "   API Docs:    http://localhost:5000/swagger"
echo ""
echo "🔍 Quick API tests:"
echo "   curl 'http://localhost:5000/api/properties?pageSize=5'"
echo "   curl 'http://localhost:5000/api/properties?name=Villa'"
echo "   curl 'http://localhost:5000/api/properties?minPrice=100000&maxPrice=500000'"